    ...
    public function process(\Magento\Framework\Webapi\Rest\Request $request)
    {
        ...
        if ($route->getServiceMethod() != 'logout') {
            ...
            if ($route->getServiceClass() != 'Magestore\Webpos\Api\Staff\StaffManagementInterface' && $route->getServiceMethod() != 'logout') {
                if ($session->getHasException() == \Magestore\Webpos\Api\Event\DispatchServiceInterface::EXCEPTION_CODE_FORCE_SIGN_OUT) {
                    throw new AuthorizationException(
                        __(\Magestore\Webpos\Api\Event\DispatchServiceInterface::EXCEPTION_MESSAGE),
                        new \Exception(),
                        \Magestore\Webpos\Api\Event\DispatchServiceInterface::EXCEPTION_CODE_FORCE_SIGN_OUT
                    );
                } elseif ($session->getHasException() == \Magestore\Webpos\Api\Event\DispatchServiceInterface::EXCEPTION_CODE_FORCE_CHANGE_POS) {
                    ...
                    if (($route->getServiceClass() != 'Magestore\Webpos\Api\Pos\PosRepositoryInterface' && $route->getServiceMethod() != 'assignPos')
                        ...
                        throw new AuthorizationException(
                            __(\Magestore\Webpos\Api\Event\DispatchServiceInterface::EXCEPTION_MESSAGE),
                            new \Exception(),
                            \Magestore\Webpos\Api\Event\DispatchServiceInterface::EXCEPTION_CODE_FORCE_CHANGE_POS
                        );
                    }
                }
            }
